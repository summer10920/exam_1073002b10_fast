...
INSERT INTO `t5_effect` (`once`) VALUES
(1);
...
INSERT INTO `t5_img` (`id`, `text`, `img`, `odr`, `dpy`) VALUES
...
INSERT INTO `t7_movie` (`id`, `title`, `cls`, `length`, `date`, `corp`, `maker`, `video`, `img`, `text`, `odr`, `dpy`) VALUES
...
--
-- 使用資料表 AUTO_INCREMENT `t5_img`
--
ALTER TABLE `t5_img`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- 使用資料表 AUTO_INCREMENT `t7_movie`
--
ALTER TABLE `t7_movie`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- 使用資料表 AUTO_INCREMENT `t8_book`
--
ALTER TABLE `t8_book`
