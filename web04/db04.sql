...
INSERT INTO `t4_class` (`id`, `text`, `parent`) VALUES
(1, '流行皮件', 0),
(2, '流行鞋區', 0),
(3, '流行飾品', 0),
(4, '背包', 0),
...
INSERT INTO `t5_product` (`id`, `fa`, `son`, `title`, `price`, `spec`, `num`, `img`, `text`, `dpy`) VALUES
...
INSERT INTO `t8_order` (`id`, `user`, `name`, `mail`, `addr`, `tel`, `buy`, `date`, `total`) VALUES
...
INSERT INTO `t9_user` (`id`, `acc`, `pwd`, `name`, `mail`, `addr`, `tel`, `date`) VALUES
...
INSERT INTO `t10_admin` (`id`, `acc`, `pwd`, `access`) VALUES
...
INSERT INTO `t11_footer` (`once`) VALUES
('this is footer');
...
-- 資料表索引 `t4_class`
--
ALTER TABLE `t4_class`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `t5_product`
--
ALTER TABLE `t5_product`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `t8_order`
--
ALTER TABLE `t8_order`
  ADD PRIMARY KEY (`id`);
...
--
-- 使用資料表 AUTO_INCREMENT `t4_class`
--
ALTER TABLE `t4_class`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- 使用資料表 AUTO_INCREMENT `t5_product`
--
ALTER TABLE `t5_product`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- 使用資料表 AUTO_INCREMENT `t8_order`
--
ALTER TABLE `t8_order`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用資料表 AUTO_INCREMENT `t9_user`
--
ALTER TABLE `t9_user`
